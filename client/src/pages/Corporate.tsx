      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {corporateFeatures.map((feat, idx) => (
            <div key={idx} className="rounded-xl border border-line bg-bg-surface p-6">
              <CheckCircle2 className="h-8 w-8 text-brand-orange" />
              <h3 className="mt-4 font-display text-lg font-bold text-strong">{feat.title}</h3>
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
          ...
          {/* Info */}
          <div className="space-y-6 rounded-xl border border-line bg-bg-surface p-8">
            <h2 className="font-display text-2xl font-bold text-strong">Why Global Tech Teams Trust NxtGen Academy</h2>
            ...
            <div className="space-y-4 pt-4 border-t border-line">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-bold text-sm text-strong">10,000+ Engineers Trained</h4>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-bold text-sm text-strong">SOC2 & Enterprise Data Protection</h4>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-bold text-sm text-strong">Vendor Certified Instructors</h4>
          ...
          {/* Lead Form */}
          <div className="rounded-xl border border-line bg-bg-surface p-8">
            <h2 className="font-display text-2xl font-bold text-strong">Request a Custom Corporate Quote</h2>
            ...
            {submitted ? (
              <div className="my-12 text-center">
                ...
                <h4 className="mt-4 text-xl font-bold text-strong">Proposal Request Submitted!</h4>
                <p className="mt-2 text-sm text-text-muted">
                  An enterprise account manager will contact <strong className="text-strong">{form.workEmail}</strong> within 4 business hours.
                </p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full rounded-lg bg-brand-orange py-3 text-sm font-semibold text-on-brand hover:bg-brand-orange/90 shadow-lg"
                >
