...
const AIConfig = () => {
  ...
  return (
    <div className="max-w-3xl space-y-6 p-6 text-white">
      <div>
      ...
      <form onSubmit={handleSave} className="rounded-xl border border-white/[0.08] bg-bg-surface p-6 space-y-6">
        <div>
          ...
          <select
            ...
            className="mt-2 w-full rounded-lg border border-white/[0.08] bg-bg-card p-3 text-sm text-white focus:border-brand-orange"
          >
