              ...
              <BrowserRouter>
                <Suspense fallback={<Loading />}>
                  <Routes>
                    ...
                    {/* Career Toolkit — open to everyone, signed in or not. The
                    public nav and home page link here, so without this group
                    every tool 404s for guests and site users. Saving and
                    exporting stay gated inside each tool. */}
                    <Route
                    ...
                    >
                      ...
                      />
                      {/* Absorbed into the editor as the "Strengthen CV"
                          section. Redirected rather than dropped so any
                          existing link lands somewhere useful. */}
                      <Route
                        path="upload-enhance"
                        element={<Navigate to="resume-builder" replace />}
                      />
                    ...
                    {/* Linked from the footer. No policy text has been written yet,
                    so these say so rather than 404 — inventing legal wording
                    would be worse than admitting it isn't published. */}
                    <Route
                      path="/privacy"
                      element={
                        <StatusPage kind="comingSoon" title="Privacy Policy" />
                      }
                    />
                    <Route
                      path="/terms"
